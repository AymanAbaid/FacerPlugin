...
public class FACERSearchService   {
    ...
    public ArrayList getRecommendationsForQuery(String query) {
        ...
        try {
            ...
            JSONArray results = studentsEvaluator.searchMethodsFACERAS(query, 10, configurationComponent.getDatabaseURL(), configurationComponent.getResourcesFolderRootPath());
            if (results != null) {
    ...
    public ArrayList getRelatedMethods(int methodId) {
        ...
        try {
            ...
            JSONArray relatedMethods = relatedMethodsEvaluator.getRelatedMethods(methodId, 3, configurationComponent.getDatabaseURL(), configurationComponent.getResourcesFolderRootPath());
